<?php if( !isset( $formTagStarted ) ):?>
	<?php  echo form_tag_for($form, '@structure_child' ) ?>
<?php endif;?>
<?php echo $form->renderHiddenFields()?>
  ...
  <table id="job_form" style="float:left;padding-right:100px">
	...
	<tr>
	  <th><?php echo $form['parameter']->renderLabel('Additional parameter',array('class'=>'formLabel')); ?></th>
	  <td>
  ...
  <table>
  	<tbody>
	<tr>
	  <th><?php echo $form['slug']->renderLabel('URL',array('class'=>'formLabel')); ?></th>
	  <td>
