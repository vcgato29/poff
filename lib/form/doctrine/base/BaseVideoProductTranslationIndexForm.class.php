...
/**
 * VideoProductTranslationIndex form base class.
 *
 * @method VideoProductTranslationIndex getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseVideoProductTranslationIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('video_product_translation_index[%s]');
