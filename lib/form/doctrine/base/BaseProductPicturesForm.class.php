...
/**
 * ProductPictures form base class.
 *
 * @method ProductPictures getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseProductPicturesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_pictures[%s]');
