...
/**
 * ProductTranslationIndex form base class.
 *
 * @method ProductTranslationIndex getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseProductTranslationIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_translation_index[%s]');
