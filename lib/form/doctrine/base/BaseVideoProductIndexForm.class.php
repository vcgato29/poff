...
/**
 * VideoProductIndex form base class.
 *
 * @method VideoProductIndex getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseVideoProductIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('video_product_index[%s]');
