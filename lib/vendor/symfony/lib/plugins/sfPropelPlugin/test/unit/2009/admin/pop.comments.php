 ...
 */
  ...
  if (!$recStructure->boolClose) 
  {
    ...
    if ((@in_array($_GET["action"], array("delete")) and $arrGlobalRights[$_GET["ID"]] == "write") or (@in_array($_GET["action"], array("select", "insert")) and $arrGlobalRights[$_GET["parentID"]] == "write")) 
    {
      include(MODULE_DIR . "structure/actions.comments.inc");
    } 
  ...
  $engSmarty->display("admin/pop.comments.tpl");
?>