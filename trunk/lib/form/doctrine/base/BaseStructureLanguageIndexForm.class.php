...
/**
 * StructureLanguageIndex form base class.
 *
 * @method StructureLanguageIndex getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseStructureLanguageIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('structure_language_index[%s]');
