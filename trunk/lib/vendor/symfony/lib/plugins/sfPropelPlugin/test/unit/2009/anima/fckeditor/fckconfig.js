...
//FCKConfig.ToolbarSets["HelpCms"] = [
//	['Source','-','Save','Preview','-'],
//	['Cut','Copy','Paste','PasteText','PasteWord','-'],
//	['Undo','Redo','-','RemoveFormat', 'Style'],
//	'/',
//	['Bold','Italic','Underline','-'],
//	['OrderedList','UnorderedList','-','Outdent','Indent'],
//	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
//	['Link','Unlink','Anchor'],
//	['Flash', 'Image','Table','SpecialChar','Templates']
//] ;
...
var _QuickUploadLanguage	= 'perl' ;	// asp | aspx | cfm | lasso | php
