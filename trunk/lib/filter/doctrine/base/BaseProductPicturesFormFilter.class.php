...
/**
 * ProductPictures filter form base class.
 *
 * @package    jobeet
 * @subpackage filter
 ...
 */
abstract class BaseProductPicturesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_pictures_filters[%s]');
