...
// date: 2010/11/15 13:28:58
  ...
  'cache_dir' => '/data03/virt1199/domeenid/www.poff.ee/2010/cache/backend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/data03/virt1199/domeenid/www.poff.ee/2010/apps/backend/i18n',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'MySessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('my_session'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/data03/virt1199/domeenid/www.poff.ee/2010/cache/backend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/data03/virt1199/domeenid/www.poff.ee/2010/apps/backend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'aneto1@gmail.com',
      'password' => 'foo2008gmail1',
    ),
  ),
))));
