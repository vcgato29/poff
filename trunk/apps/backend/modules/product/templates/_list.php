    ...
    <table cellspacing="0">
      <thead>
        <tr>
          ...
          <?php include_partial('product/list_th_tabular', array('sort' => $sort,'helper' => $helper)) ?>
        ...
        <tr>
          <th colspan="10">
            <?php if ($pager->haveToPaginate()): ?>
              <?php include_partial('product/pagination', array('pager' => $pager,'helper' => $helper)) ?>
            <?php endif; ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $i => $product): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
          <tr class="sf_admin_row <?php echo $odd ?>">
            ...
            <?php include_partial('product/list_td_tabular', array('product' => $product,'helper' => $helper)) ?>
